    ...
    async function handleSetValue(e) {
        ...
        if (contract) {
            try {
                ...
                }, [address,firmAdd, firmname, firmlocation, ownername, ownercontact, city,"Logistics"]); 
                const transaction = {
                    from: address,
                    to: proxyAddress,
                    data: data,
            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-sm-12" style={{ borderRight: "1px solid black", padding: "1rem" }} >
                        <h2 className='text-center' >Logistics Registration</h2>
                        <form className="row g-3" onSubmit={handleSetValue}>
                            <div className="col-md-12">
                                <label htmlFor="inputName" className="form-label"> Logistics Wallet Address</label>
                                <input type="text" className="form-control" id="inputName" value={firmAdd} onChange={(e) => setFirmAdd(e.target.value)} />
                            </div>
                            <div className="col-md-12">
                                <label htmlFor="inputName" className="form-label">Logistics Name</label>
                                <input type="text" className="form-control" id="inputName" value={firmname} onChange={(e) => setFirmname(e.target.value)} />
                            </div>
                            <div className="col-md-12">
                                <label htmlFor="inputName" className="form-label">Logistics Location</label>
